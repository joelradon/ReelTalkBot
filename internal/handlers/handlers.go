...
// MessageProcessor defines the methods that the telegram and facebook packages require from the app package.
type MessageProcessor interface {
	...
	ProcessFacebookMessage(senderID, messageText string) (string, error)
	HandleFacebookCommand(senderID, messageText string) (string, error)
}
